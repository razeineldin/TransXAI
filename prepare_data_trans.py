...
def create_table(dataset_dir, table_data_shape, save_dir, crop_coordinates, data_channels, k_fold=None, view='axial'):
    ...
    hdf5_file    = tables.open_file(os.path.join(save_dir + 'data0.hdf5'), mode='w')
    ...
    if k_fold:
        ...
        for fold in range(k_fold):
            ...
            if fold == 0:
                ...
                shutil.copyfile(os.path.join(save_dir + 'data0.hdf5'), os.path.join(save_dir + 'data{}.hdf5'.format(fold)))
            
    
if __name__ == '__main__':
      
    create_table(cfg['data_dir'], cfg['table_data_shape'], cfg['save_data_dir'], 
                 cfg['crop_coord'], cfg['data_channels'], cfg['k_fold'], cfg['view'])
